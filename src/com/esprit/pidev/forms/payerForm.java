 ...
 * @author ASUS
 */
public class payerForm extends SideMenuBaseForm {

      private Form current,f;
      Resources res;
         private static final int[] COLORS = {0xf8e478, 0x60e6ce, 0x878aee};
    private static final String[] LABELS = {"Design", "Coding", "Learning"};
    public payerForm(Resources res,float montant) {
           ...
           //    f = new Form("Reservation", BoxLayout.y());
            ...
            ComboBox comb = new ComboBox("edinar","cartebancaire");
            //ComboBox comb2 = new ComboBox(montant);

           Label comb2 = new Label("Montant : " + montant);

   

    
       
        Button btn = new Button("payer");
btn.setUIID("ButtonStyle");
  ...
  this.add(btn);
        ...
        btn.addActionListener((evt) -> {
                    ...
                    Paiement a = new Paiement(1,comb.getSelectedItem().toString(),montant);
                  PaiementService service = new PaiementService();

                    service.addPaiement(a) ;

                        Dialog.show("SUCCESS", "paiement effectuée", "OK", null);
